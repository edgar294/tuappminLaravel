                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="form.bloque" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="form.apartamento" required>
                                    </div>
                                </div>                                                              
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {                        
            ...
            _getAttrib() {
                ...
                this.form.apartamento = this.form.apartamento;
